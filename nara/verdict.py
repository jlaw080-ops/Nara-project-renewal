...
# '예정' 계열 — 미래 일정 표기. 뒤의 넷은 기간 단위 미래 표현이다.
# 준공을 보도할 때는 날짜를 쓴다("26일 준공식"). '하반기 준공'처럼 반년
# 단위로 쓰는 건 아직 안 됐다는 뜻이다. 실측 오판: 2023년 기사
# "동백1동 행정복지센터, 2025년 하반기 준공"이 '준공 완료'가 됐다.
#
# '2027년 준공' 같은 일반 패턴은 넣지 않는다 — '지난해 준공'처럼 진짜
# 준공 보도까지 잡는다. 회고적으로 쓰인 '상반기 준공된 체육관'이
# 위임되는 것은 감수한다. 안전한 방향으로 실패하는 쪽이 낫다.
_PLANNED_WORDS = (
    "예정",
    "목표",
    "계획",
